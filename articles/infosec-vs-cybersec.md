...
本記事は[Cyber-sec+ Advent Calendar 2024](https://adventar.org/calendars/10158)の 21 日目の記事になります。
...
情報セキュリティ部に所属しているから情報セキュリティ？ IoT 機器の開発に携わっているから IoT セキュリティ？ CSPM を扱っているを扱っているからクラウドセキュリティという人もいるかもしれません。
...
今回は、会社の部署としてありがちな**情報セキュリティ**と**サイバーセキュリティ**という 2 つの用語の使い分けについて考察していきたいと思います。
...
これらの定義から分かるように、これらは MECE に分かれるものではなく、お互いの領域は密接に関連し、多くの場合オーバーラップしています。
...
これら 2 つの人材は互いに排反な可能性がそこそこ高く、技術が好きな人をガバナンス系 Excel 業務にアサインすると「仕事がつまらない」と言って人材流出したり、逆の場合は必要とされる技術力に押しつぶされてメンタルを傷つけたりするケースもあります。
- **専門性の向上**
